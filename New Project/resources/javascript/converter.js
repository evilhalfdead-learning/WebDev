...
const unitCategory = {
	inches: 'length', centimeters: 'length', miles: 'length', kilometers: 'length',
...
const baseFactors = {
	length: { inches: 0.0254, centimeters: 0.01, miles: 1609.34, kilometers: 1000 },
...
const unitLabels = {
	inches: 'in', centimeters: 'cm', miles: 'mi', kilometers: 'km',
